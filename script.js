...
const introLines = [
  "إلى بسملة... 🌸",
  "",
  "ربما لا تعرفين كيف يمكن لشيءٍ صغير",
  "أن يحمل بداخله عالمًا كاملًا...",
  "",
  "شمعةٌ أضاءت،",
  "ورائحةٌ عبرت بهدوء،",
  "وقليلٌ من الضوء قادكِ إلى هنا.",
  "",
  "لكن الحقيقة أن هذا العالم",
  "لم يبدأ من هنا...",
  "",
  "بدأ من اللحظة التي عرفتكِ فيها،",
  "ومنذ ذلك الوقت",
  "وأنا أرى الأشياء الجميلة بطريقةٍ مختلفة.",
  "",
  "صرتُ أرى الربيع فأفكر في ابتسامتكِ،",
  "وأرى الخريف فأجد في هدوئه شيئًا منكِ،",
  "وأحب الشتاء لأن دفءه يشبه قربكِ،",
  "أما الصيف...",
  "ففي نوره شيءٌ يشبه عينيكِ حين تفرحين.",
  "",
  "فقلت لنفسي:",
  "",
  "كيف يمكن أن أجمع كل هذا الجمال",
  "في مكانٍ واحد؟",
  "",
  "فصنعتُ لكِ هذا العالم...",
  "",
  "ليس لأنه أجمل مكانٍ يمكن أن تريه،",
  "بل لأنني أردتُ أن يكون هناك مكانٌ واحد على الأقل",
  "كلما دخلتِ إليه...",
  "",
  "تجدين فيه شيئًا يشبهكِ.",
  "",
  "بسملة،",
  "إن كان لهذا العالم بداية،",
  "فهي أنتِ.",
  "",
  "وإن كان له أجمل ما فيه...",
  "",
  "فهو أنكِ هنا الآن. ❤️"
];
